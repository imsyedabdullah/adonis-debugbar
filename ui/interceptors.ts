...
/** Read the debugbar request ID for the initial page load. */
export function getInitialPageId(): string | null {
  if (typeof window === 'undefined') return null;
  // Primary: injected by {{{ debugbar }}} Edge global
  if (typeof window.__DEBUGBAR_ID__ === 'string') return window.__DEBUGBAR_ID__;
  // Fallback: Inertia page props (_debugbarId if manually injected)
  try {
